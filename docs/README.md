...
For technical documentation, architecture details, and contribution guidelines, see the [Developer Documentation](dev/README.md).

## Quick Links

- [Main README](../README.md) - Project overview and quick start
- [Configuration Reference](configuration.md) - All settings explained
- [CLI Commands](../README.md#cli-reference) - Command reference
